                            ...
                            foreach ( $jobapp_fields as $key => $val ):
                                if (isset($val['type']) && isset($val['option'])):
                                    if (substr($key, 0, 7) == 'jobapp_'):
                                        ...
                                        . '<input type="checkbox" value="' . $val['optional'] . '" class="settings-jobapp-required-field"  ' . $val['optional'] . ' />' . esc_html__('Required', 'simple-job-board') . ' &nbsp; '
